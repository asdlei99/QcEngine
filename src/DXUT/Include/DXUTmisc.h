...
#define DXUT_ERR(c_str,hr)           DXUTTrace( __FILE__, (DWORD)__LINE__, hr, c_str, false )
#define DXUT_ERR_MSGBOX(c_str,hr)    DXUTTrace( __FILE__, (DWORD)__LINE__, hr, c_str, true )
#define DXUTTRACE                  DXUTOutputDebugString
#else
#define DXUT_ERR(c_str,hr)           (hr)
#define DXUT_ERR_MSGBOX(c_str,hr)    (hr)
